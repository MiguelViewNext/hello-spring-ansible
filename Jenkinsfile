...
pipeline {
    ...
    stages {
        ...
        stage ('Delivery') {
            steps {
                echo 'Delivering...'
                //tag 'docker tag 10.250.9.3:5050/movbit/hello-spring-sonar/hello-spring:latest 10.250.9.3:5050/movbit/hello-spring-sonar/hello-spring:TESTING-1.0.${BUILD_NUMBER}'
